...
class DICOMFilterConverter:
    def __init__(self):
        ...
        self.MIN_SLICES = 401      # > 400 slice (almeno 401)
        ...
        self.input_folder = "C:/Users/sagli/Downloads/test"  # Cartella con i DICOM
        self.output_folder = "filtered_mhd_output"            # Cartella output
    ...
    def check_dicom_parameters(self, dicom_files, folder_name):
        ...
        try:
            ...
            # 1. Controlla numero di slices - MODIFICATO: > 400
            num_slices = len(dicom_files)
            if num_slices <= 400:  # MODIFICATO: deve essere > 400
                return False, f"Slices ({num_slices}) ≤ 400 (richiesto > 400)"
    ...
    def process_dicom_folders(self, folders_list):
        ...
        print(f"  • Slices: > 400 (almeno 401)")  # MODIFICATO
        ...
        for folder_name, folder_path, file_count in folders_list:
            ...
            try:
                ...
                print(f"     • Slices: {metadata['slices']} (> 400 ✓)")
                ...
                if success:
                    ...
                    log_details = (f"Slices: {metadata['slices']} (> 400 ✓), "
    ...
    def _save_metadata(self, folder_name, metadata, output_path):
        ...
        with open(meta_file, 'w', encoding='utf-8') as f:
            ...
            f.write("=" * 40 + "\n")
            f.write(f"Numero di slices: {metadata['slices']} (> 400 ✓)\n")
    ...
    def generate_final_report(self):
        ...
        with open(report_file, 'w', encoding='utf-8') as f:
            ...
            f.write("-" * 40 + "\n")
            f.write(f"Slices per CT: > 400 (almeno 401 slice)\n")  # MODIFICATO
            f.write(f"Slice thickness: ≥ {self.MIN_SLICE_THICKNESS} mm\n")
            f.write(f"XY resolution: {self.MIN_XY_RESOLUTION}-{self.MAX_XY_RESOLUTION} mm\n")
            f.write(f"Data type: 16-bit signed int\n\n")
    ...
    def run(self):
        ...
        print("=" * 70)
        print("CRITERIO SLICE: > 400 (almeno 401 slice)\n")  # MODIFICATO
        ...
        if self.stats['converted'] > 0:
            ...
            if slices_count:
                ...
                print(f"  - Tutti > 400: {'SI' if min_slices > 400 else 'NO'}")
